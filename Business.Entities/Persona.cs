...
{
    class Persona:BusinessEntities
    {
        ...
        public DateTime FechaNacimiento { set { _FechaNacimiento = value; } get { return _FechaNacimiento; } }
        ...
        public TipoPersonas TipoPersona { set { _TipoPersona = value; } get { return _TipoPersona; } }
